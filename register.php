...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query add user
    $result = mysqli_query($mysqli, "INSERT INTO user (nama,email,password) VALUES('$nama','$email','$password')");
                ...
                <form method="POST" action="register.php">
                    <div class="form-group" data-animation="fadeInLeft" data-delay=".8s">
                        <div class="input-group mb-3">
                            <input class="form-control" name="nama" id="nama" type="text" placeholder="Masukkan Nama" required="required">
                        </div>
                    </div>
                    <div class="form-group" data-animation="fadeInLeft" data-delay=".8s">
                        <div class="input-group mb-3">
                            <input class="form-control" name="email" id="email" type="email" placeholder="Masukkan Email" required="required">
                        </div>
                    </div>
                    <div class="form-group" data-animation="fadeInLeft" data-delay=".8s">
                        <div class="input-group mb-3">
                            <input class="form-control" name="password" id="password" type="password" placeholder="Masukkan Password" required="required">
                        </div>
                    </div>
